...
<table border="0" cellpadding="2">
    <tbody>
        <tr>
            <td colspan="3">Pada hari ini <?php echo date('d M Y');?> buku kas ditutup.</td>
        </tr>
        <tr>
            <td style="width: 150px">Saldo Kas Umum</td>
            <td style="width: 50px;">Rp</td>
            <td style="width: 200px;"><?php echo!empty($dataCetak['SALDO_KAS_UMUM']) ? number_format($dataCetak['SALDO_KAS_UMUM'], 2) : ''; ?></td>
        </tr>
        <tr>
        ...
        <tr>
            <td>Saldo Bank</td>
            <td>Rp</td>
            <td style="width: 200px;"><?php echo!empty($dataCetak['SALDO_BANK']) ? number_format($dataCetak['SALDO_BANK'], 2) : ''; ?></td>
        </tr>
        <tr>
            <td>Saldo Tunai</td>
            <td>Rp</td>
            <td style="width: 200px;"><?php echo!empty($dataCetak['SALDO_TUNAI']) ? number_format($dataCetak['SALDO_TUNAI'], 2) : ''; ?></td>
        </tr>
    </tbody>
</table>
<br/>
