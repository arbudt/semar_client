...
<div class="row-fluid">
    <form class="form well" method="POST" id="formBosk5">
...
<script>
    $(document).ready(function(){
        ...
        $(document).on("keydown", "input,select,textarea", function(event) {
            if (event.keyCode === 13) {
                var formInput = $('#formBosk5').find('input,select,textarea, button, checkbox');
...
<script>
    ...
    function getAllDataTrans(){
        ...
        if(tahun.length && triwulan.length){
            $.ajax({
                type: "POST",
                url: "<?php echo site_url('bosk5/bosk5/getDataTrans') ?>",
    ...
    function getDataByidTrans(idTrans){
        if(idTrans !== null){
            $.ajax({
                type: "POST",
                url: "<?php echo site_url('bosk5/bosk5/getDataByIdTrans') ?>",
    ...
    $(document).on('click', '#btnDelete', function(){
        ...
        if(idTrans.length){
            if(confirm('Yakin akan menghapus data ini')){
                $.ajax({
                    type: "POST",
                    url: "<?php echo site_url('bosk5/bosk5/prosesDelete') ?>",
                    data: {idTrans:idTrans},
                    dataType: 'json',
                    beforeSend: function(xhr) {
    ...
    $(document).ready(function() {
        $('#formBosk5').validate({
            submitHandler: function(form) {
                $.ajax({
                    type: "POST",
                    url: "<?php echo site_url('bosk5/bosk5/prosesSimpan') ?>",
                    data: $('#formBosk5').serialize(),
                    dataType: 'json',
                    beforeSend: function(xhr) {
